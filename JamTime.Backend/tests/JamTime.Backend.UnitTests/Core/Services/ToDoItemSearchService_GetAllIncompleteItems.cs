...
using JamTime.Backend.Core.ProjectAggregate;
using JamTime.Backend.Core.Services;
using JamTime.Backend.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace JamTime.Backend.UnitTests.Core.Services
{
